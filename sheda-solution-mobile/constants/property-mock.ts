export const properties = [
      ...
      reviews: [
        {
          ...
          name: "Jane Smith",
          comment:
            "Seller is welcoming and nice, also the apartment i got was exactly as described.",
          date: "23/02/2024",
        },
        {
          id: 2,
  ...
  },
  {
    ...
    mode: "buy",
    description:
      "This tastefully furnished modern self-contained apartment is located at km 20, lekki-ajah expressway, 5 minutes drive from moobil filling station.",
    extras: [
      "Air Conditioning",
      "POP Ceiling",
      "Running Water",
