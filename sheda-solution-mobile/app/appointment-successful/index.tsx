...
<View className="flex-1 justify-center items-center">
    <View className="w-24 h-24 bg-[#D8DADC26] rounded-full justify-center items-center">
        ...
        <View className="my-4">
            <InterSemiBold className="text-base/5 mb-1 text-center">Commitment successful</InterSemiBold>
            <InterRegular className="text-sm/5 text-center text-secondaryText">Your funds will be locked with us until both you and the seller agree to release.</InterRegular>
        </View> 
        ...
        <View className="w-full">
            ...
            className="rounded-lg">
                <InterSemiBold className="text-sm/5 text-white">Book an appointment</InterSemiBold>
            </Button>
        </View>
</View>
            </SafeAreaView>
