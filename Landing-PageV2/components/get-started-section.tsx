    ...
    <section className="py-16 px-4 md:py-24">
      <div className="container mx-auto max-w-7xl">
        <div className="bg-[#C13A3A] rounded-3xl overflow-hidden relative">
          {/* Net pattern overlay */}
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] md:w-[800px] md:h-[500px] opacity-30 pointer-events-none"
            style={{
          ...
          {/* Desktop Layout */}
          <div className="hidden md:flex items-center justify-between p-12 lg:p-16 relative z-10">
            {/* Left Content */}
          ...
          {/* Mobile Layout */}
          <div className="md:hidden p-8 text-center relative z-10">
